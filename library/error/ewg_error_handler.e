...
feature -- Reporting errors
	...
	report_parsed_successfuly_message is
			-- Report 'parsed successfully' message
		do
			report_info (Parsed_successfuly_message)
		end

	report_obsolete_syntax_is_used_message is
	...
	report_quitting_because_of_config_file_errors_error (a_config_file_name: STRING) is
		require
	...
	report_info_message (a_message: STRING) is
	...
	report_wrong_config_root_element_error (an_element_name: STRING; a_position: XM_POSITION) is
	...
	report_missing_config_attribute_error (a_containing_element: XM_ELEMENT; an_attribute_name: STRING; a_position: XM_POSITION) is
	...
	report_missing_config_element_error (a_containing_element: XM_ELEMENT; an_element_name: STRING; a_position: XM_POSITION) is
	...
	report_unexpected_element_error (an_expected_element_name: STRING; an_element: XM_ELEMENT; a_position: XM_POSITION) is
	...
	report_unknown_config_element_error (a_containing_element: XM_ELEMENT; an_element: XM_ELEMENT; a_position: XM_POSITION) is
	...
	report_unknown_config_wrapper_type_error (an_element: XM_ELEMENT; a_position: XM_POSITION) is
	...
	report_unknown_config_construct_type_error (an_element: XM_ELEMENT; a_position: XM_POSITION) is
			-- Report that the value of the attribute "type"
	...
	report_invalid_class_name_error (an_element: XM_ELEMENT; a_position: XM_POSITION) is
...
feature -- Progress indication
	...
	set_current_task_total_ticks (a_ticks: INTEGER) is
	...
	set_current_task_has_no_total_ticks is
...
feature {NONE} -- Progress bar implementation
	...
	remove_characters (n: INTEGER) is
	...
	update_current_line (a_string: STRING) is
	...
	make_current_line_permanent is
	...
	spinn_characters: ARRAY [CHARACTER] is
		once
...
feature
	...
	Obsolete_syntax_is_used_message: UT_MESSAGE is
	...
	Parsed_successfuly_message: UT_MESSAGE is
	...
	Version_number: STRING is "0.9.0"
