...
/*
 * This hack is needed for lcc-win32 only.
 * The SDLmain.lib cannot be used for lcc-win32, because
 * it is VC specific.
 * Also for some reason, one must not use this as a library.
 * It will only work when linked as an object file.
 */
...
#ifdef __APPLE__
int SDL_main_eiffel (int argc, char** argv, char** envp);

extern char** environ;

int SDL_main (int argc, char** argv)
{
  SDL_main_eiffel (argc, argv, environ);
}
#endif
