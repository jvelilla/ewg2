indexing
	...
	description:
		...
		"Closure for gtk 'focus-out-event' signal"
...
deferred class GTK_FOCUS_OUT_EVENT_SIGNAL_RECEIVER
...
feature {G_SHARED_CLOSURE_MARSHAL_DISPATCHER}
	...
	on_query (a_return_value: G_VALUE; a_parameters: G_VALUE_ARRAY) is
		...
		do
			...
			a_return_value.set_boolean (on_focus_out_event (widget, event))
		end
