indexing
	...
	description:
		...
		"Closure for gtk 'configure_event' signal"
...
deferred class GTK_CONFIGURE_EVENT_SIGNAL_RECEIVER
...
feature {G_SHARED_CLOSURE_MARSHAL_DISPATCHER}
	...
	on_query (a_return_value: G_VALUE; a_parameters: G_VALUE_ARRAY) is
		...
		do
			...
			a_return_value.set_boolean (on_configure_event (widget, event))
		end
